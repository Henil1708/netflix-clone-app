...
const SignUpScreen = ({navigation}) => {
  ...
  return (
    ...
    <View style={styles.root}>
      ...
      <CustomInputComponent placeholder={'First name'} value={firstname} setValue={setFirstname} />
      <CustomInputComponent placeholder={'Last name'} value={lastname} setValue={setLastname} />
      ...
      <CustomButton onClick={loginPressed} design={styles.loginBtn} text={'Signup'} />
      <View style={styles.signUp}>
      <Text style={styles.question}>Already on Netflix?</Text>
